...
class getInterface {
    ...
    get_myComp(stuId, compStateID) {
        return new Promise((resolve, reject) => {
            this.get_CompStateName(compStateID).then(results => {
                ...
                let sql = sql_func.query_multiple3('stu_team', 'teamcompetion', 'competition', akesy, bkeys, ckeys, {teamId: 'teamId'}, {CompId: 'CompId'}, {
                    IsPass: 1,
                    stuId
                }, compStateID >= 8 ? {IsPass: 1} : null, {compStateID})
                if (compStateID !== 1) {
    ...
    myComps(stuId, status) {
        switch (status) {
            case -1:
                return this.get_myAllComp(stuId);
                break;
            case 0:
                return this.get_myAllComp(stuId);
                break;
            case 1:
                return this.get_myApplyComp(stuId);
                break;
            case 2:
                return this.get_myRunningComp(stuId);
                break;
            case 3:
                return this.get_myEndComp(stuId);
                break;
    ...
    get_teamApplyment(teamId) {
        return new Promise((resolve, reject) => {
            ...
            let sql = sql_func.query_multiple('stu_team', 'student', akeys, bkeys, {stuId: 'stuId'}, {
                teamId,
                IsPass: 0
            })
            mysql.query(sql[0], sql[1], function (err, rows) {
    ...
    * */
    ...
    LatestComps(status, limit) {
        switch (status) {
            case -1:
                return this.get_AllLatestComp(limit);
                break;
            case 0:
                return this.get_AllLatestComp(limit);
                break;
            case 1:
                return this.get_ApplyLatestComp(limit);
                break;
            case 2:
                return this.get_RunningLatestComp(limit);
                break;
            case 3:
                return this.get_EndLatestComp(limit);
                break;
        }
    }
    ...
    Comps(status, limit) {
        switch (status) {
            case -1:
                return this.get_AllComp(limit);
                break;
            case 0:
                return this.get_AllComp(limit);
                break;
            case 1:
                return this.get_ApplyComp(limit);
                break;
            case 2:
                return this.get_RunningComp(limit);
                break;
            case 3:
                return this.get_EndComp(limit);
                break;
        }
    ...
    CompSum(status) {
        switch (status) {
            case -1:
                return this.get_AllCompSum();
                break;
            case 0:
                return this.get_AllCompSum();
                break;
            case 1:
                return this.get_ApplyCompSum();
                break;
            case 2:
                return this.get_RunningCompSum();
                break;
            case 3:
                return this.get_EndCompSum();
                break;
        }
    }
